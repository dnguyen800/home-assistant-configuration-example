class WeatherCard extends HTMLElement {
  set hass(hass) {
    ...
    this.content.innerHTML = `
      <span class="icon bigger" style="background: none, url(/local/icons/weather_icons/animated/${weatherIcons[currentCondition]}.svg) no-repeat; background-size: contain; color: #718B3A;">cloudy</span>
